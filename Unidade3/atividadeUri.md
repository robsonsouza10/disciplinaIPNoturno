...
<!-- [x]TODO:INICIO atualizar -->
para criar uma conta e se inscreverem na disciplina criada dentro do URI. A disciplina tem o nome: IP_NOT [2022-2].  

<!-- [x]TODO:INICIO atualizar -->
Assim que acessar a disciplina informe a seguinte chave de acesso (token): X7dTA3E 
...
1) crie caso já não tenha um projeto Java no VSCode com o nome "Unidade3";  
